  ...
  enviarInformacoes() {
    ...
    return (0,E_Repos_AgendaAe_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this.infoAgendamento.valid) {
        ...
        _this.href = `${_this.url}send?phone=+${_this.codigoPais}${_this.whatsNumero}&text=Olá Mohrana, sou ${_this.infoAgendamento.value.nome} ${_this.infoAgendamento.value.sobrenome}, gostaria de confirmar meu horário dia ${_this.data} às ${_this.hora} para o serviço de ${_this.nome}.`;
        ...
        infoCliente.servico = _this.nome;
        infoCliente.precoServico = _this.preco;
...
let EnviarAgendamentoService = class EnviarAgendamentoService {
    ...
    adicionarReserva(dia, hora) {
        ...
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.setDoc)(agendaDocRef, { horarios: (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.arrayUnion)(hora) }, { merge: true });
    }
